            ...
            <div class="col-sm-4 centered">
                <form class="form-horizontal" action="/login" method="post" role="form">
                    ...
                    <div class="centered" style="margin-top: 10px;">
                        <span id="showPassword" class="badge structurizrBackgroundLighter" style="cursor:default;"><img src="/static/bootstrap-icons/eye.svg" class="icon-sm icon-white" /> Show password</span>
                        <span id="hidePassword" class="badge structurizrBackgroundLighter hidden" style="cursor:default;"><img src="/static/bootstrap-icons/eye-slash.svg" class="icon-sm icon-white" /> Hide password</span>
                    </div>
